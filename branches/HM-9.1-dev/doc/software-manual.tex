...
\ShortOption{\None} &
\Default{0} &
Enables or disables the insertion of the frame_packing_arrangement SEI messages.
\par
\begin{tabular}{cp{0.45\textwidth}}
  0 & Disabled \\
  1 & Enabled \\
...
\ShortOption{\None} &
\Default{0} &
Indicates the arrangmenet type in the frame_packing_arrangement SEI message.
...
\ShortOption{\None} &
\Default{0} &
Indicates the constituent frames relationship in the frame_packing_arrangement SEI message. 
This option has no effect if SEIFramePacking is disabled.
\par
\begin{tabular}{cp{0.45\textwidth}}
  0 & Unspecified \\
...
frame_packing_arrangement SEI messages. This option has no
...
\ShortOption{\None} &
\Default{0} &
Indicates the session number in the frame_packing_arrangement
